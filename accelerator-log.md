...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tfynes-pivotal&repo=python-function1",
  "functionName" : "main",
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "python-function1"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->python-function1, main->main]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tfynes-pivotal&repo=python-function1'
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [python-function->python-function1]
